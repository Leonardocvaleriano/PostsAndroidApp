...
fun ExplorePostsScreenRoot(
    ...
    val isLoading by explorePostsViewModel.isLoading.collectAsState()
    val posts by explorePostsViewModel.posts.collectAsState()
    val errorMessage by explorePostsViewModel.errorMessage.collectAsState()
